...
std::string robot_finds_kitten::getmessage(int idx)
{
	...
	_("A wheel of cheese with flaming elephants engraved on it."),
	_("[DATA EXPUNGED]"),
	_("This is an aluminium shopping cart. All craftsurvivorship is of the highest quality."),
	_("The best editor of ALL TIME! And a Vim tarball next to it. Yuck!"),
	_("The best editor of ALL TIME! And an Emacs tarball next to it. Yuck!"),
	_("A portal showing a bleak future without bionics. You can't imagine living there."),
	_("You see here a set of all sets that don't contain themselves."),

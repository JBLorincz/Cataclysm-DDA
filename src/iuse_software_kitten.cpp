...
std::string robot_finds_kitten::getmessage(int idx)
{
	...
	-("A wheel of cheese with flaming elephants engraved on it."),
	-("[DATA EXPUNGED]"),
	_("This is an aluminium shopping cart. All craftsurvivorship is of the highest quality."),
	-("The best editor of ALL TIME! And a Vim tarball next to it. Yuck!"),
	-("The best editor of ALL TIME! And an Emacs tarball next to it. Yuck!"),
	-("A portal showing a bleak future without bionics. You can't imagine living there."),
	-("You see here a set of all sets that don't contain themselves."),
